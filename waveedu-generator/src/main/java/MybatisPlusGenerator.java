        ...
        FastAutoGenerator.create("jdbc:mysql://8.134.136.211:3306/wave_edu?characterEncoding=utf-8&useSSL=false&serverTimezone=GMT%2B8", "root", "123456")
                .globalConfig(builder -> {
                    builder.author("狐狸半面添") // 设置作者
                            ...
                            .outputDir("D:\\SoftwareEngineering\\java\\project\\waveedu\\waveedu-share\\src\\main\\java"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.zhulang.waveedu") // 设置父包名
                            .moduleName("share") // 设置父包模块名
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "D:\\SoftwareEngineering\\java\\project\\waveedu\\waveedu-share\\src\\main\\resources\\mapper")); // 设置mapperXml生成路径
                })
                .strategyConfig(builder -> {
                    builder.addInclude("share_resource") // 设置需要生成的表名
                            .addTablePrefix("share_"); // 设置过滤表前缀
                })
