...
@NoArgsConstructor
@AllArgsConstructor
public class BatchSaveCommonHomeworkQuestionVO {
    ...
    @Valid
    @NotNull(message = "未检测到题目数据")
    @Size(min = 1, message = "未检测到题目数据")
    private List<InnerQuestion> innerQuestionList;

    @Data
    @NoArgsConstructor
    @AllArgsConstructor
    public static class InnerQuestion {
        /**
